...
public class Person implements Steppable {
	...
	private DefecationNeed defecationNeed;
	...
	public Person(WorldModel model, long id, Family family) {
		...
		this.defecationNeed = new DefecationNeed(this);
	...
	public void step(SimState model) {
		...
		defecationNeed.update(); // this will update the status of the defecation need
		infectiousDisease.update(); // this will update the status of the infectious disease
	...
	public boolean physiologicalNeedsSatisfied() {
		return foodNeed.isSatisfied() == true
				...
				&& defecationNeed.isSatisfied() == true;
	}
	...
	public void bury() {
		...
		this.defecationNeed.kill();
		this.defecationNeed = null;
	...
	public DefecationNeed getDefecationNeed() {
		return defecationNeed;
	}
