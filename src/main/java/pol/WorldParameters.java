...
public class WorldParameters extends AnnotatedPropertied {
	...
	public static final LocalDateTime WARMUP_PERIOD_END_TIME = LocalDateTime.parse("2024-01-31");
	...
	public static final String DEFAULT_MAPS = "atlanta";
	...
	public static final int MAX_DAYS_TO_BE_IN_URGENT_NEED_TO_DEFECATE = 0;
	...
	public static final double DEFECATION_RATE_LOWER_BOUND = 0.2;
	public static final double DEFECATION_RATE_UPPER_BOUND = 0.8;
	...
	@EditableProperty(group = "Init", description = "Number days allowed to be in urgent need to defecate status", lower = "3", upper = "10", readOnly = false)
	public int maxDaysToBeInUrgentNeedToDefecate;
	...
	public double defecationRateLowerBound;
	public double defecationRateUpperBound;
	...
	protected void initializationWithDefaultValues() {
		...
		maxDaysToBeInUrgentNeedToDefecate = MAX_DAYS_TO_BE_IN_URGENT_NEED_TO_DEFECATE;
		...
		defecationRateLowerBound = DEFECATION_RATE_LOWER_BOUND;
		defecationRateUpperBound = DEFECATION_RATE_UPPER_BOUND;
