...
public class PredefinedTables implements java.io.Serializable {
	...
	public class CheckinDataset implements java.io.Serializable {
		...
		public PoopinTable PoopinTable = new PoopinTable();

		public class PoopinTable extends Table {
			public Column UserId = new Column();
			public Column PoopinTime = new Column();
			public Column X = new Column();
			public Column Y = new Column();
			public Column VenueType = new Column();
		...
		public DiseasesStatusTable DiseasesStatusTable = new DiseasesStatusTable();

		public class DiseasesStatusTable extends Table {
			public Column Time = new Column();
			public Column UserId = new Column();
			public Column ExposedStartedTime = new Column();
			public Column InfectiousStartedTime = new Column();
			public Column PathogenLevel = new Column();
			public Column DiseaseStatus = new Column();
